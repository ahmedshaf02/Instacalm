...
const hanldeDeletePost=(postId)=>{
  ...
  .then(result=>{
    ...
    M.toast({html:"deleted post successfully",classes:"teal lighten-2"})
  })
  .catch(err=>{
     console.log(err,"error")
  })
                    ...
                    <div className="postMain">
                      ...
                      <div className="margin">
                        ...
                        <i onClick={()=>handleLikePost(ele._id)} class="material-icons pointer">thumb_up</i>
                          ...
                          {
                            ele.comment.map(ele=>(
                              <h6><b>{ele.postedBy.name}</b>: {ele.text}</h6>
                          ))
                          }
                      </div>
                    ...
                    <div className="postFooter">
                      ...
                      <form onSubmit={e=>{
                        ...
                        <div class="input-field col s6">
                          ...
                          <label for="icon_prefix">Add the comments *</label>
                        </div>
                      </form>
                    </div>
                </div>
